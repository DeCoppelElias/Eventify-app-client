    ...
    return (
        <div className='flex h-full w-full'>
            ...
            <div className='h-full w-full bg-gray-900 pr-20 pl-20'>
                <EventsSidebar state={"InvitedEvents"} createEventPopupRef={createEventPopupRef}/>
                        ...
                        <div className='bg-gray-800 rounded-md mb-10 w-full'>
                            <div className='pt-3 pl-4 pr-4 w-full'>
                                <div className='flex pb-3'>
                                    <p className='sm:w-1/8 md:w-1/7 lg:w-1/6 xl:w-1/4 text-2xl text-white'>Event Invitations</p>
